...
function Play()
	...
	if facility.HaveReadableBook == true then
		...
		-- 本を読む/読まない
		open_select_window_tag(Noir, "Normal", "AC_01_0120011", "AC_01_0120012")
...
function AC_01_012A_Inst_start()
...
function AC_01_012A_Inst_cancel()



end

function AC_01_012A_Inst_nobook()
...
--	load_area_scene(110061) -- 大図書院
	...
	setup_101009_Noir({3.16, 0, 9.746, 0}, "Com_Sit_Reading_Loop_Chr_002_01", 0, true, "content_animationpack_201_201noir", "MotionPack_201NoirWork")
...
--	on_parent(Book, Noir, "Loc_weapon_constrint_L", 0,0,0, 0,0,180)
	...
	MAIN_CAMERA = set_camera(1.9698, 1.8099, 11.2764, 19.412, 141.392, 2.55, 23.7421)
...
function AC_01_012A_Main_finish()



end

function AC_01_012A_Main_unfinish()
