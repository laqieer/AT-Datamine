-- このluaスクリプトは、ND_01105_01.csvから自動生成されました --
...
function Play()
	...
	--★★キャメロット騎士学術院（女）★★:
	Talk(Actor001,"NPCNAME_0385","speech","L","ND_01105_010001")


	--★★キャメロット騎士学術院（女）★★:
	Talk(Actor001,"NPCNAME_0385","speech","L","ND_01105_010002")


	--★★キャメロット騎士学術院（女）★★:
	Talk(Actor001,"NPCNAME_0385","speech","L","ND_01105_010003")


	--★★キャメロット騎士学術院（女）★★:
	Talk(Actor001,"NPCNAME_0385","speech","L","ND_01105_010004")


	--★★キャメロット騎士学術院（女）★★:
	Talk(Actor001,"NPCNAME_0385","speech","L","ND_01105_010005")
...
-- ▲直接出力
	...
	--★★ノワール★★:
	Talk(Actor002,"PLAYERNAME_NOIR","speech","L","ND_01105_010006")
