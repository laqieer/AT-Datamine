...
function Play()
	...
	--★★フレン★★:あれ？ノワールくんだ！<br>どうかした？
	Talk(Actor002,"CHRNAME_FREN","speech","L","CO_101039_00010001")
	CloseTalkWindow()

	kizuna_rankup_hint()		-- ランクアップ示唆

	open_select_window_tag(Actor001,"Normal","CO_101039_00010003","CO_101039_00010004")
	CloseTalkWindow()

	if is_select(1) then

		--★★フレン★★:お出かけ？<br>いいよー！行こ行こ！
		Talk(Actor002,"CHRNAME_FREN","speech","L","CO_101039_00010005")

		local locations = commu.GetLocations() -- GetLocations()※複数形
		if communication_place_select(locations) then -- ロケーション選択

			--★★フレン★★:やったー！<br>ちょうど行きたいと思ってたところなんだ！
			Talk(Actor002,"CHRNAME_FREN","speech","L","CO_101039_00010007")
		else
			--★★フレン★★:そっか。じゃあ、またね！
			Talk(Actor002,"CHRNAME_FREN","speech","L","CO_101039_00010006")
