...
function Play()
	...
	--★★ランスロット★★:ノワール。どうかしたか？
	Talk(Actor002,"CHRNAME_LANCELOT","speech","L","CO_101010_00010001")
	CloseTalkWindow()

	kizuna_rankup_hint()		-- ランクアップ示唆

	open_select_window_tag(Actor001,"Normal","CO_101010_00010003","CO_101010_00010004")
	CloseTalkWindow()

	if is_select(1) then

		--★★ランスロット★★:そうだな<br>たまには気晴らしもいいだろう
		Talk(Actor002,"CHRNAME_LANCELOT","speech","L","CO_101010_00010005")

		local locations = commu.GetLocations() -- GetLocations()※複数形
		if communication_place_select(locations) then -- ロケーション選択
			--★★ランスロット★★:よし、行こうか
			Talk(Actor002,"CHRNAME_LANCELOT","speech","L","CO_101010_00010007")
		else
			--★★ランスロット★★:そうか。ではな
			Talk(Actor002,"CHRNAME_LANCELOT","speech","L","CO_101010_00010006")
			system.Cancel()
		end
