...
function Load()
	...
	Actor001 = InitializeCharacter("101009","002","101009002",CharaPos001,"101009002","Chr_002_01_StdController","to Std_Loop")
...
--luaのインポート時にPreLoadする対象をLoadから自動検出して追加する
	...
	local charaId = string.sub(strStyleId,1,6)
	local styleId = string.sub(strStyleId,7,9)
	InitializeCharacter_Preload("101009","002","101009002",CharaPos001,"101009002","Chr_002_01_StdController","to Std_Loop")
