...
function Play()
	...
	Talk(Actor001,"PLAYERNAME_NOIR","mind","L","ND_00201_020001")
	...
	if is_select(1) then
		...
		Talk(Actor001,"PLAYERNAME_NOIR","mind","L","ND_00201_020004")
	else
		Talk(Actor001,"PLAYERNAME_NOIR","mind","L","ND_00201_020005")
	end
