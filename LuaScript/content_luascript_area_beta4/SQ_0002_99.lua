...
function Play()
	...
	--★★キャメロット軍兵士_下位★★:大型バルバロイを倒してくれたみたいだな<br>さすがはノワールだ！
	Talk(Actor002,"NPCNAME_0351","speech","N","SQ_0002_99001")


	--★★キャメロット軍兵士_下位★★:これは今回の報酬だ<br>ぜひ受け取ってほしい
	Talk(Actor002,"NPCNAME_0351","speech","N","SQ_0002_99002")
