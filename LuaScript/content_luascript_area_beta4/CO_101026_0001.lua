...
function Play()
	...
	--★★パーシヴァル★★:やあ、ノワール<br>ぼくになにか用でもあるのかな？
	Talk(Actor002,"CHRNAME_PERCIVAL","speech","L","CO_101026_00010001")
	CloseTalkWindow()

	kizuna_rankup_hint()		-- ランクアップ示唆

	open_select_window_tag(Actor001,"Normal","CO_101026_00010003","CO_101026_00010004")
	CloseTalkWindow()

	if is_select(1) then

		--★★パーシヴァル★★:ぼくを接待しようというのか<br>悪くない考えだね
		Talk(Actor002,"CHRNAME_PERCIVAL","speech","L","CO_101026_00010005")

		local locations = commu.GetLocations() -- GetLocations()※複数形
		if communication_place_select(locations) then -- ロケーション選択
			--★★パーシヴァル★★:ふむ、いいだろう
			Talk(Actor002,"CHRNAME_PERCIVAL","speech","L","CO_101026_00010007")
		else
			--★★パーシヴァル★★:なんの用もないのに話しかけてきたのか？<br>庶民の考えることはよくわからないな
			Talk(Actor002,"CHRNAME_PERCIVAL","speech","L","CO_101026_00010006")
			system.Cancel()
		end
