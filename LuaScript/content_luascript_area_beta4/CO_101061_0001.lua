...
function Play()
	...
	--★★ラロゥ★★:ノワールじゃん<br>なにか用？
	Talk(Actor002,"CHRNAME_LAROU","speech","L","CO_101061_00010001")
	CloseTalkWindow()

	kizuna_rankup_hint()		-- ランクアップ示唆

	open_select_window_tag(Actor001,"Normal","CO_101061_00010003","CO_101061_00010004")
	CloseTalkWindow()

	if is_select(1) then

		--★★ラロゥ★★:ふーん。ま、いいけど？<br>で、どこに連れてってくれるワケ？
		Talk(Actor002,"CHRNAME_LAROU","speech","L","CO_101061_00010005")

		local locations = commu.GetLocations() -- GetLocations()※複数形
		if communication_place_select(locations) then -- ロケーション選択

			--★★ラロゥ★★:ま、悪くないね
			Talk(Actor002,"CHRNAME_LAROU","speech","L","CO_101061_00010007")
		else
			--★★ラロゥ★★:あっそ<br>つまんない奴
			Talk(Actor002,"CHRNAME_LAROU","speech","L","CO_101061_00010006")
