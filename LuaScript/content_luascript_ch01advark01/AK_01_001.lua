-- このluaスクリプトは、AK_01_001.csvから自動生成されました --
...
slidemove(Actor002,{0, 0, -16.579},2.8)
wait_time(1.2)
setup_small_camera_start(RndCamera005)
wait_time(1.6)
PlayActionDirect(Actor002,"to Std_Loop")
wait_time(1.2)
ShowTutorialPopup(83)
...
-- ▲直接出力
	...
	--★★アルハン★★:準備ができたようだな
	Talk(Actor001,"NPCNAME_0313","speech","L","AK_01_0010002")
...
-- ▲直接出力
	...
	--★★アルハン★★:では行ってこい<br>キサマならできると信じているぞ
	Talk(Actor001,"NPCNAME_0313","speech","L","AK_01_0010003")
