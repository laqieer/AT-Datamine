-- このluaスクリプトは、MA_01A110_39.csvから自動生成されました --
...
function template1()
	...
	Camera006 = SetTemplate("Actor006",nil,CharaPos110011_07_002,"content_motion3d_advarea_common_adv_templatecontroller","Chr_520_01_StdController","to Std_Loop",CameraAssetBundleName110011_07,CameraPos110011_07_002)
...
-- ▲直接出力
	...
	--★★エレイン★★:き、「騎士様…こんな危険を賭してまで」ヒュッ<br>「どうして私なんかを助けてくださるのですか」
	Talk(Actor006,"CHRNAME_ELAINE","speech","L","MA_01A110_390002")

	play_head_motion(Actor006, "No", 0.3, 1.0, false)

	--★★エレイン★★:お「臆病で…けれどみんなを助けたいと」えと<br>あー「望みばかりが果てしない、欲張りな私を」
	Talk(Actor006,"CHRNAME_ELAINE","speech","L","MA_01A110_390003")
...
-- ▲直接出力
	...
	--★★マルディサント★★:このヘタクソがッッ！！
	Talk(Actor005,"CHRNAME_MALADISANT","speech","N","MA_01A110_390005")

	PlayAction(Actor006,"to  Std_Sad02")
-- ▼直接出力
 --PlayPartVoice("エレイン", "苦しみ")
-- ▲直接出力
	on_cutin(2,Actor006,"Pain")
	change_face(Actor006,"Sad")

	--★★エレイン★★:ひゃあああ！？
	Talk(Actor006,"CHRNAME_ELAINE","speech","N","MA_01A110_390006")
...
-- ▲直接出力
	...
	Talk(Actor003,"CHRNAME_DINATAN","speech","L","MA_01A110_390007")
...
-- ▲直接出力
	...
	--★★ガウェイン★★:やってるかー？
	Talk(Actor008,"CHRNAME_GAWAIN","speech","L","MA_01A110_390009")
...
-- ▲直接出力
	...
	Talk(Actor005,"CHRNAME_MALADISANT","speech","L","MA_01A110_390010")

-- ▼直接出力
 --PlayPartVoice("ラグネル", "納得")
-- ▲直接出力

	--★★ラグネル★★:ええ～？<br>店の飾り付けだって大変なんだよー？
	Talk(Actor009,"CHRNAME_RAGNAR","speech","L","MA_01A110_390011")
...
-- ▲直接出力
	...
	--★★ガウェイン★★:差し入れ持ってきたぜ<br>ノワール、エレイン
	Talk(Actor008,"CHRNAME_GAWAIN","speech","L","MA_01A110_390012")
...
-- ▲直接出力
	...
	--★★エレイン★★:ご飯ですか…！
	Talk(Actor006,"CHRNAME_ELAINE","speech","L","MA_01A110_390013")
...
-- ▲直接出力
	...
	Talk(Actor005,"CHRNAME_MALADISANT","speech","L","MA_01A110_390014")
...
-- ▲直接出力
	...
	--★★ノワール★★:俺は…
	Talk(Actor001,"CHRNAME_NOIR","speech","L","MA_01A110_390015")
...
-- ▲直接出力
	...
	--★★マルディサント★★:代役も同罪だボケ！！
	Talk(Actor005,"CHRNAME_MALADISANT","speech","L","MA_01A110_390016")
...
-- ▲直接出力
	...
	--★★ラグネル★★:ファイトー！<br>ノワール、エレインー！
	Talk(Actor009,"CHRNAME_RAGNAR","speech","L","MA_01A110_390017")
...
keep_ik_lookat(Actor002,bread01,"Pro_1057")
...
-- ▲直接出力
	...
	Talk(Actor005,"CHRNAME_MALADISANT","speech","L","MA_01A110_390019")
...
-- ▲直接出力
	...
	--★★ギネヴィア★★:いただきま～す
	Talk(Actor002,"CHRNAME_GUINEVERE","speech","L","MA_01A110_390021")
...
-- ▲直接出力
	...
	--★★ディナタン★★:お先に～
	Talk(Actor003,"CHRNAME_DINATAN","speech","L","MA_01A110_390022")
...
-- ▲直接出力
	...
	--★★エレイン★★:ああああ、ご飯………
	Talk(Actor006,"CHRNAME_ELAINE","speech","L","MA_01A110_390023")
...
-- ▲直接出力
	...
	Talk(Actor005,"CHRNAME_MALADISANT","speech","L","MA_01A110_390024")
...
-- ▲直接出力
	...
	--★★モルガン★★:やってる～？
	Talk(Actor004,"CHRNAME_MORGAN","speech","L","MA_01A110_390026")
...
-- ▲直接出力
	...
	Talk(Actor005,"CHRNAME_MALADISANT","speech","L","MA_01A110_390027")
...
-- ▲直接出力
	...
	Talk(Actor004,"CHRNAME_MORGAN","speech","L","MA_01A110_390029")
...
-- ▲直接出力
	...
	--★★ディナタン★★:食べます？
	Talk(Actor003,"CHRNAME_DINATAN","speech","L","MA_01A110_390030")
...
-- ▲直接出力
	...
	--★★モルガン★★:食べる食べる～
	Talk(Actor004,"CHRNAME_MORGAN","speech","L","MA_01A110_390031")
...
-- ▲直接出力
	...
	--★★ラヴェイン★★:やってますか？
	Talk(Actor007,"CHRNAME_LOVEIN","speech","L","MA_01A110_390033")
...
-- ▲直接出力
	...
	--★★エレイン★★:お兄ちゃ──
	Talk(Actor006,"CHRNAME_ELAINE","speech","L","MA_01A110_390034")
...
-- ▲直接出力
	...
	--★★マルディサント★★:やり合ってる最中だよ！<br>テメ―は運営で多忙だろ、帰れ！！
	Talk(Actor005,"CHRNAME_MALADISANT","speech","L","MA_01A110_390036")
...
-- ▲直接出力
	...
	--★★ギネヴィア★★:ラヴェイン、ゴハン食べる？
	Talk(Actor002,"CHRNAME_GUINEVERE","speech","L","MA_01A110_390037")
...
-- ▲直接出力
	...
	Talk(Actor007,"CHRNAME_LOVEIN","speech","L","MA_01A110_390038")
...
-- ▲直接出力
	...
	--★★ノワール★★:お、俺たちのゴハンが…
	Talk(Actor001,"CHRNAME_NOIR","speech","L","MA_01A110_390039")
...
-- ▲直接出力
	...
	Talk(Actor005,"CHRNAME_MALADISANT","speech","L","MA_01A110_390041")
...
-- ▲直接出力
	...
	--★★エレイン★★:そ、そうです、よね…<br>でも…見せたい、楽しんでもらいたい…
	Talk(Actor006,"CHRNAME_ELAINE","speech","L","MA_01A110_390042")
...
-- ▲直接出力
	...
	--★★マルディサント★★:いったん諦めろ
	Talk(Actor005,"CHRNAME_MALADISANT","speech","L","MA_01A110_390043")
...
-- ▲直接出力
	...
	--★★エレイン★★:へっっ…！？
	Talk(Actor006,"CHRNAME_ELAINE","speech","L","MA_01A110_390044")
...
-- ▲直接出力
	...
	--★★マルディサント★★:それでも立ち向かいてえモノが<br>テメエには…テメエにだけはあんじゃねえの？
	Talk(Actor005,"CHRNAME_MALADISANT","speech","L","MA_01A110_390045")
...
-- ▲直接出力
	...
	--★★ラヴェイン★★:ありますね、エレインには
	Talk(Actor007,"CHRNAME_LOVEIN","speech","L","MA_01A110_390046")
...
turn_lookat(Actor002,Actor006,0.5)
wait_time(0.2)
...
-- ▲直接出力
	...
	--★★ギネヴィア★★:なんの…ハナシ？
	Talk(Actor002,"CHRNAME_GUINEVERE","speech","L","MA_01A110_390047")
...
-- ▲直接出力
	...
	--★★モルガン★★:青春～
	Talk(Actor004,"CHRNAME_MORGAN","speech","L","MA_01A110_390048")
...
-- ▲直接出力
	...
	--★★エレイン★★:え？え？えぇ？
	Talk(Actor006,"CHRNAME_ELAINE","speech","L","MA_01A110_390049")
...
-- ▲直接出力
	...
	--★★マルディサント★★:客が<ruby=ごっこ>物語の虚構</ruby>を信じるためには<br>登場人物本人の真なる部分ってのが必要なんだ
	Talk(Actor005,"CHRNAME_MALADISANT","speech","L","MA_01A110_390050")

	play_head_motion(Actor005, "Nod", 0.3, 1.0, false)

	--★★マルディサント★★:みっともない部分とか、内側の──<br>そーゆーのがさ
	Talk(Actor005,"CHRNAME_MALADISANT","speech","L","MA_01A110_390052")
...
-- ▲直接出力
	...
	Talk(Actor005,"CHRNAME_MALADISANT","speech","L","MA_01A110_390053")
...
-- ▲直接出力
	...
	Talk(Actor005,"CHRNAME_MALADISANT","speech","L","MA_01A110_390054")
...
-- ▲直接出力
	...
	--★★エレイン★★:………身内のひとにこそ、です
	Talk(Actor006,"CHRNAME_ELAINE","speech","L","MA_01A110_390056")
