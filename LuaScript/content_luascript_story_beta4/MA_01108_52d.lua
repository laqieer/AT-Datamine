...
function Load()
	...
	pbadv_setup_101012_Dinatan(1,true, 5, 20,0)  
	...
	barbaroi5 = dot_reserve_enemy(304, 9, 17, 0) 
	barbaroi6 = dot_reserve_enemy(304, 9, 21, 0) 
...
--luaのインポート時にPreLoadする対象をLoadから自動検出して追加する
	...
	pbadv_setup_101012_Dinatan_preload(1,true, 5, 20,0)
