-- このluaスクリプトは、PT7_01_02_002.csvから自動生成されました --
...
-- ▲直接出力
	...
	Talk(Actor001,"CHRNAME_NOIR","speech","L","PT7_01_02_0020001")
...
-- ▲直接出力
	...
	Talk(Actor002,"NPCNAME_0351","speech","N","PT7_01_02_0020002")
...
-- ▲直接出力
	...
	Talk(Actor001,"CHRNAME_NOIR","speech","L","PT7_01_02_0020003")
...
-- ▲直接出力
	...
	--★★キャメロット軍兵士_上位★★:偵察隊から<br>魔物が発生したと連絡があった
	Talk(Actor002,"NPCNAME_0351","speech","N","PT7_01_02_0020004")

	PlayAction(Actor002,"to  Std_Talk")

	--★★キャメロット軍兵士_上位★★:街の安全を守るため<br>至急、これを排除してもらいたい
	Talk(Actor002,"NPCNAME_0351","speech","N","PT7_01_02_0020005")
...
-- ▲直接出力
	...
	--★★ノワール★★:オーケー<br>すぐに行ってくるよ
	Talk(Actor001,"CHRNAME_NOIR","speech","L","PT7_01_02_0020006")
