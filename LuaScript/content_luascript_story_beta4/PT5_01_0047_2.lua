-- このluaスクリプトは、PT5_01_0047_2.csvから自動生成されました --
...
-- ▲直接出力
	...
	Talk(Actor002,"CHRNAME_CHRISTINA","speech","L","PT5_01_00470002")

	play_head_motion(Actor002, "Nod", 0.3, 1.0, false)

	--★★クリスティーナ★★:そのなかでももっとも標高の高いのが<br>スノードン山よ
	Talk(Actor002,"CHRNAME_CHRISTINA","speech","L","PT5_01_00470003")


	--★★クリスティーナ★★:スノードン山はそれだけではなくて<br>霊峰としても知られているわ
	Talk(Actor002,"CHRNAME_CHRISTINA","speech","L","PT5_01_00470004")
...
-- ▲直接出力
	...
	Talk(Actor002,"CHRNAME_CHRISTINA","speech","L","PT5_01_00470005")

	PlayAction(Actor002,"to Greet_one")

	--★★クリスティーナ★★:ここまで聞いて登ってみたいと思った人<br>手を上げて？
	Talk(Actor002,"CHRNAME_CHRISTINA","speech","L","PT5_01_00470006")
...
-- ▲直接出力
	...
	Talk(Actor002,"CHRNAME_CHRISTINA","speech","L","PT5_01_00470010")

	PlayAction(Actor002,"to  Std_Worry")
	change_face(Actor002,"Smile")

	--★★クリスティーナ★★:私も素敵な王子様に出会う運をもらうために<br>今度行ってみようと思っているわ♪
	Talk(Actor002,"CHRNAME_CHRISTINA","speech","L","PT5_01_00470011")
...
-- ▲直接出力
	...
	Talk(Actor002,"CHRNAME_CHRISTINA","speech","L","PT5_01_00470013")
...
::Block1end::
	...
	Talk(Actor002,"CHRNAME_CHRISTINA","speech","L","PT5_01_00470014")


	--★★クリスティーナ★★:スノードン山の登山道は険しいうえに<br>山頂付近は常に吹雪いていると聞くわ
	Talk(Actor002,"CHRNAME_CHRISTINA","speech","L","PT5_01_00470015")
...
-- ▲直接出力
	...
	Talk(Actor002,"CHRNAME_CHRISTINA","speech","L","PT5_01_00470016")
