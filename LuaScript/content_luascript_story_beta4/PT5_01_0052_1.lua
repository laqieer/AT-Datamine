-- このluaスクリプトは、PT5_01_0052_1.csvから自動生成されました --
...
function Play()
	...
	Talk(Actor004,"CHRNAME_KAY","speech","L","PT5_01_00520002")
...
-- ▲直接出力
	...
	Talk(Actor004,"CHRNAME_KAY","speech","L","PT5_01_00520003")
...
-- ▲直接出力
	...
	Talk(Actor004,"CHRNAME_KAY","speech","L","PT5_01_00520004")
...
-- ▲直接出力
	...
	Talk(Actor004,"CHRNAME_KAY","speech","L","PT5_01_00520009")
...
-- ▲直接出力
	...
	Talk(Actor004,"CHRNAME_KAY","speech","L","PT5_01_00520011")

	play_head_motion(Actor004, "Nod", 0.3, 1.0, false)
	change_face(Actor004,"Normal")

	--★★ケイ★★:正しくは<br>『ブリテンの赤き竜』だ
	Talk(Actor004,"CHRNAME_KAY","speech","L","PT5_01_00520012")
...
-- ▲直接出力
	...
	Talk(Actor004,"CHRNAME_KAY","speech","L","PT5_01_00520014")
...
-- ▲直接出力
	...
	Talk(Actor004,"CHRNAME_KAY","speech","L","PT5_01_00520015")


	--★★ケイ★★:戦となれば自ら武器をもち<br>兵士たちの先頭に立って戦われたと聞く
	Talk(Actor004,"CHRNAME_KAY","speech","L","PT5_01_00520016")
...
-- ▲直接出力
	...
	Talk(Actor004,"CHRNAME_KAY","speech","L","PT5_01_00520017")
...
-- ▲直接出力
	...
	Talk(Actor004,"CHRNAME_KAY","speech","L","PT5_01_00520018")


	--★★ケイ★★:アーサー王が産まれて間もなくの頃<br>城がバルバロイに襲われ
	Talk(Actor004,"CHRNAME_KAY","speech","L","PT5_01_00520019")

	PlayAction(Actor004,"to  Std_Talk")

	--★★ケイ★★:そのときにイグレーヌ王妃を亡くされたことが<br>研究に乗り出した理由と聞いている
	Talk(Actor004,"CHRNAME_KAY","speech","L","PT5_01_00520020")
...
-- ▲直接出力
	...
	Talk(Actor004,"CHRNAME_KAY","speech","L","PT5_01_00520021")
...
-- ▲直接出力
	...
	--★★ケイ★★:ほどなくして帰らぬ人となった
	Talk(Actor004,"CHRNAME_KAY","speech","L","PT5_01_00520022")

	change_face(Actor004,"Normal")

	--★★ケイ★★:諸君らがこうしてログレスに暮らし<br>ＧＳについて学べているのは
	Talk(Actor004,"CHRNAME_KAY","speech","L","PT5_01_00520023")
...
-- ▲直接出力
	...
	Talk(Actor004,"CHRNAME_KAY","speech","L","PT5_01_00520024")
