...
function Load()
	...
	pbadv_setup_101010_Lancelot(1,true, 5, 20,0)  

	pbadv_setup_101011_Guinevere(0,true, 2, 20,0)  
	...
	barbaroi7 = dot_reserve_enemy(1301, 10, 18, 0) 
	barbaroi8 = dot_reserve_enemy(49, 11, 21, 0) 

	barbaroi9 = dot_reserve_enemy(1301, 10, 22, 0) 
	barbaroi10 = dot_reserve_enemy(49, 11, 19, 0) 
	barbaroi11 = dot_reserve_enemy(1301, 10, 20, 0) 
...
--luaのインポート時にPreLoadする対象をLoadから自動検出して追加する
	...
	pbadv_setup_101010_Lancelot_preload(1,true, 5, 20,0)
	pbadv_setup_101011_Guinevere_preload(0,true, 2, 20,0)
