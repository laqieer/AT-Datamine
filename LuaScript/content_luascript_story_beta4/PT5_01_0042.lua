-- このluaスクリプトは、PT5_01_0042.csvから自動生成されました --
...
-- ▲直接出力
	...
	Talk(Actor005,"CHRNAME_CHRISTINA","speech","L","PT5_01_00420002")

	PlayAction(Actor005,"to  Std_Talk")

	--★★クリスティーナ★★:その都の名前はサラス
	Talk(Actor005,"CHRNAME_CHRISTINA","speech","L","PT5_01_00420003")


	--★★クリスティーナ★★:サラスにまつわる文献を紐解くと<br>聖杯についての記述が数多く見られるから
	Talk(Actor005,"CHRNAME_CHRISTINA","speech","L","PT5_01_00420004")
...
-- ▲直接出力
	...
	Talk(Actor005,"CHRNAME_CHRISTINA","speech","L","PT5_01_00420005")
...
-- ▲直接出力
	...
	Talk(Actor005,"CHRNAME_CHRISTINA","speech","L","PT5_01_00420006")

	change_face(Actor005,"Normal")

	--★★クリスティーナ★★:今となっては都があった場所を知る人間すら<br>ほとんどいないそうよ
	Talk(Actor005,"CHRNAME_CHRISTINA","speech","L","PT5_01_00420007")


	--★★クリスティーナ★★:ただ、聖杯の出現に合わせて<br>サラスの都も再び現れるなんて伝承もあるわ
	Talk(Actor005,"CHRNAME_CHRISTINA","speech","L","PT5_01_00420008")
...
-- ▲直接出力
	...
	Talk(Actor005,"CHRNAME_CHRISTINA","speech","L","PT5_01_00420009")
