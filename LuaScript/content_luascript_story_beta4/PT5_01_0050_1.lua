-- このluaスクリプトは、PT5_01_0050_1.csvから自動生成されました --
...
-- ▲直接出力
	...
	Talk(Actor004,"CHRNAME_KAY","speech","L","PT5_01_00500002")


	--★★ケイ★★:このブリテン島は<br>もともとはローマ大帝国の領土のひとつだった
	Talk(Actor004,"CHRNAME_KAY","speech","L","PT5_01_00500003")

	play_head_motion(Actor004, "Nod", 0.3, 1.0, false)

	--★★ケイ★★:しかし数十年前
	Talk(Actor004,"CHRNAME_KAY","speech","L","PT5_01_00500004")
...
-- ▲直接出力
	...
	Talk(Actor004,"CHRNAME_KAY","speech","L","PT5_01_00500005")


	--★★ケイ★★:そしてその機に乗じて<br>ブリテン島各地の領主たちが領土争いをはじめた
	Talk(Actor004,"CHRNAME_KAY","speech","L","PT5_01_00500006")

	play_head_motion(Actor004, "Nod", 0.3, 1.0, false)

	--★★ケイ★★:我が国の前王ユーサーもそのひとりだ
	Talk(Actor004,"CHRNAME_KAY","speech","L","PT5_01_00500007")

	PlayAction(Actor004,"to  Std_Talk")

	--★★ケイ★★:しかしユーサー王が<br>他の領主たちと違ったのは
	Talk(Actor004,"CHRNAME_KAY","speech","L","PT5_01_00500008")
...
-- ▲直接出力
	...
	Talk(Actor004,"CHRNAME_KAY","speech","L","PT5_01_00500009")

	play_head_motion(Actor004, "Nod", 0.3, 1.0, false)

	--★★ケイ★★:ゲシュタルト・シフトの秘儀のことだな
	Talk(Actor004,"CHRNAME_KAY","speech","L","PT5_01_00500010")


	--★★ケイ★★:ゆえに１５年前<br>ローマがこの島から去ったあとも
	Talk(Actor004,"CHRNAME_KAY","speech","L","PT5_01_00500011")
...
-- ▲直接出力
	...
	Talk(Actor004,"CHRNAME_KAY","speech","L","PT5_01_00500012")

	PlayAction(Actor004,"to  Std_Worry")
	change_face(Actor004,"Surprise")

	--★★ケイ★★:…おっと、少々長くなったな<br>続きはまた次回に話すとしよう
	Talk(Actor004,"CHRNAME_KAY","speech","L","PT5_01_00500013")
