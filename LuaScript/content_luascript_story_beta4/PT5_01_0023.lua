-- このluaスクリプトは、PT5_01_0023.csvから自動生成されました --
...
-- ▲直接出力
	...
	--★★ランスロット★★:ＧＳはログレスだけに伝わる秘術ではない
	Talk(Actor002,"CHRNAME_LANCELOT","speech","L","PT5_01_00230002")

	play_head_motion(Actor002, "Nod", 0.3, 1.0, false)

	--★★ランスロット★★:剣の祭壇以外にも<br>キラーズ因子を覚醒させる場は存在し
	Talk(Actor002,"CHRNAME_LANCELOT","speech","L","PT5_01_00230003")


	--★★ランスロット★★:さらに、ＧＳに至るための<br>知識を持ち合わせる者もいるようだ
	Talk(Actor002,"CHRNAME_LANCELOT","speech","L","PT5_01_00230004")
...
-- ▲直接出力
	...
	--★★ランスロット★★:ちょうど<br>コルベニック城からの客人がそうであるようにな
	Talk(Actor002,"CHRNAME_LANCELOT","speech","L","PT5_01_00230005")


	--★★ランスロット★★:とはいえ、正規の手順を踏まぬＧＳは危険を伴う<br>そんな話も聞く
	Talk(Actor002,"CHRNAME_LANCELOT","speech","L","PT5_01_00230006")


	--★★ランスロット★★:この学園はもっとも正しくＧＳを教え
	Talk(Actor002,"CHRNAME_LANCELOT","speech","L","PT5_01_00230007")

	play_head_motion(Actor002, "Nod", 0.3, 1.0, false)

	--★★ランスロット★★:もっとも安全にキラーズやマスターを育てている<br>そんな機関であるといえるだろう
	Talk(Actor002,"CHRNAME_LANCELOT","speech","L","PT5_01_00230008")
