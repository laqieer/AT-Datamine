-- このluaスクリプトは、MA_01B900_54.csvから自動生成されました --
...
-- ▼直接出力
stillAnime = load_ui_effect("content_still_10102013_anim", "10102013_StillAnim", nil, nil, nil, "Root")
-- ▲直接出力
-- ▼直接出力
disp_calendar(false)
-- ▲直接出力
...
function Play()
	...
	--★★テロップ★★:
	Talk(Actor001,"telop","narration","N","MA_01B900_541001")


	--★★テロップ★★:
	Talk(Actor001,"telop","narration","N","MA_01B900_541002")
...
-- ▲直接出力
	...
	--★★テロップ★★:
	Talk(Actor001,"telop","narration","N","MA_01B900_541003")
...
load_ui_effect_preload("content_still_10102013_anim", "10102013_StillAnim", nil, nil, nil, "Root")
