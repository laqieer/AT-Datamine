...
function Load()
	...
	ED_Anime = load_ui_effect("content_still_10103022_anim", "10103022_StillAnim", nil, nil, nil, "Root")
...
--luaのインポート時にPreLoadする対象をLoadから自動検出して追加する
	...
	load_ui_effect_preload("content_still_10103022_anim", "10103022_StillAnim", nil, nil, nil, "Root")
	disableTextBox = true
