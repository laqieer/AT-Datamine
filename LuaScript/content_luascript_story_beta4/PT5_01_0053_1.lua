-- このluaスクリプトは、PT5_01_0053_1.csvから自動生成されました --
...
-- ▲直接出力
	...
	Talk(Actor005,"CHRNAME_KAY","speech","L","PT5_01_00530002")


	--★★ケイ★★:あれがいつ頃、誰によって建てられたのかは<br>定かではない
	Talk(Actor005,"CHRNAME_KAY","speech","L","PT5_01_00530003")


	--★★ケイ★★:現在のログレスの建物とは<br>建築様式が大きく異なることから
	Talk(Actor005,"CHRNAME_KAY","speech","L","PT5_01_00530004")
...
-- ▲直接出力
	...
	Talk(Actor005,"CHRNAME_KAY","speech","L","PT5_01_00530005")


	--★★ケイ★★:この島では、あの建築物のような<br>時代にそぐわぬ遺跡や遺物が多数確認されている
	Talk(Actor005,"CHRNAME_KAY","speech","L","PT5_01_00530006")
...
-- ▲直接出力
	...
	Talk(Actor005,"CHRNAME_KAY","speech","L","PT5_01_00530007")
...
-- ▲直接出力
	...
	Talk(Actor005,"CHRNAME_KAY","speech","L","PT5_01_00530008")
...
-- ▲直接出力
	...
	Talk(Actor005,"CHRNAME_KAY","speech","L","PT5_01_00530009")
