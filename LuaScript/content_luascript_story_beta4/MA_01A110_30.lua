-- このluaスクリプトは、MA_01A110_30.csvから自動生成されました --
...
-- ▲直接出力
	...
	--★★キャメロット騎士学術院（男）★★:ノワールくん<br>モルガン先生が療養院に来てって
	Talk(Actor002,"NPCNAME_0001","speech","N","MA_01A110_300002")
...
-- ▲直接出力
	...
	--★★ノワール★★:モルガン先生が俺に？<br>なんだろう…
	Talk(Actor001,"CHRNAME_NOIR","speech","L","MA_01A110_300003")
